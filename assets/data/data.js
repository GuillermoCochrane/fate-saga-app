  ...
  sagas:[
    ...
    },
    {
      ...
      seasons: [
        ...
        {
          id: "prisma-movie-licht-mini",
          label: "Fate/kaleid liner Prisma☆Illya Movie: Licht - Namae no Nai Shoujo Mini Anime",
          format: "ONA",
          completed: false,
          opened: false,
          episodes: [
            {
              id: "prisma-licht-mini-1",
              number: 1,
              label: "Fate/kaleid liner Prisma Illya: Licht Nameless Girl Mini Anime Episode 1",
              romaji: "Fate/kaleid liner Prisma Illya: Licht Nameless Girl Mini Anime Episode 1",
              jp: "Fate/kaleid liner プリズマ☆イリヤミニアニメ 第1話",
              es: "Fate/kaleid liner Prisma Illya: Licht - La Chica sin Nombre Mini Anime Episodio 1",
              completed: false
            },
            {
              id: "prisma-licht-mini-2",
              number: 2,
              label: "Fate/kaleid liner Prisma Illya: Licht Nameless Girl Mini Anime Episode 2",
              romaji: "Fate/kaleid liner Prisma Illya: Licht Nameless Girl Mini Anime Episode 2",
              jp: "Fate/kaleid liner プリズマ☆イリヤミニアニメ 第2話",
              es: "Fate/kaleid liner Prisma Illya: Licht - La Chica sin Nombre Mini Anime Episodio 2",
              completed: false
            },
            {
              id: "prisma-licht-mini-3",
              number: 3,
              label: "Fate/kaleid liner Prisma Illya: Licht Nameless Girl Mini Anime Episode 3",
              romaji: "Fate/kaleid liner Prisma Illya: Licht Nameless Girl Mini Anime Episode 3",
              jp: "Fate/kaleid liner プリズマ☆イリヤミニアニメ 第3話",
              es: "Fate/kaleid liner Prisma Illya: Licht - La Chica sin Nombre Mini Anime Episodio 3",
              completed: false
            }
          ]
        },
    ...
    },
    {
      ...
      seasons: [
          ...
          episodes: [
            {
              id: "apoc-1",
              number: 1,
              label: "Apocrypha: The Great Holy Grail War",
            ...
            },
            {
              id: "apoc-4",
              number: 4,
              label: "Life's Cost, Death's Redemption",
            ...
            },
            {
              id: "apoc-9",
              number: 9,
              label: "A Hundred Flames, A Hundred Flowers",
            ...
            },
            {
              id: "apoc-12",
              number: 12,
              label: "The Saint's Triumphant Return",
            ...
            },
            {
              id: "apoc-15",
              number: 15,
              label: "Though Our Paths Diverge",
        ...
        {
          id: "fate-apocrypha-recaps",
          label: "Fate/Apocrypha Recaps",
          format: "Especial",
          completed: false,
          opened: false,
          episodes: [
            {
              id: "apoc-recap-1",
              number: 1,
              label: "The Great Holy Grail War - Turmoil Chapter",
              romaji: "Seihai Taisen Douran-hen",
              jp: "Fate/Apocrypha 聖杯大戦動乱編",
              es: "La Gran Guerra del Santo Grial - Arco de la Batalla",
              completed: false
            },
            {
              id: "apoc-recap-2",
              number: 2,
              label: "The Great Holy Grail War - Commencement Chapter",
              romaji: "Seihai Taisen Kaimaku-hen",
              jp: "Fate/Apocrypha 聖杯大戦開幕編",
              es: "La Gran Guerra del Santo Grial - El Comienzo",
              completed: false
            }
          ]
        },
          ...
          episodes: [
            {
              id: "extra-1",
              number: 1,
              label: "Praeteritus Limbus Vorago",
              romaji: "Ima wa Furuki Hengoku no Soko: Preteritus Rinbus Woraago",
              jp: "今は旧き辺獄の底 ―プレテリトゥス・リンブス・ヴォラーゴ",
              es: "Praeteritus Limbus Vorago",
              completed: false
            },
            {
              id: "extra-2",
            ...
            },
            {
              id: "extra-3",
              number: 3,
              label: "Golden Wild Hunt",
              romaji: "Ougon Shishi to Arashi no Yoru: Golden Wild Hunt",
              jp: "黄金鹿と嵐の夜 ゴールデン・ワイルドハント",
              es: "La cacería salvaje dorada",
              completed: false
            },
            {
              id: "extra-4",
              number: 4,
              label: "No Face May King",
              romaji: "Kao no Nai Ou: No Face Mei King",
              jp: "顔の無い王 ―ノフェイス・メイキング",
              es: "El camuflaje mágico",
              completed: false
            },
            {
              id: "extra-5",
            ...
            },
            {
              id: "extra-6",
              number: 6,
              label: "The Queen's Glass Game",
              romaji: "Eikyuukikan Shoujo Teikoku: Queens Glass Game",
              jp: "永久機関・少女帝国 ―クイーンズ・グラスゲーム―",
              es: "El juego de cristal de la reina",
              completed: false
            },
            {
              id: "extra-7",
              number: 7,
              label: "Nursery Rhyme",
              romaji: "Dareka no Tame no Monogatari: Nursery Rhyme",
              jp: "誰かの為の物語 ―ナーサリー・ライム―",
            ...
            },
            {
              id: "extra-9",
              number: 9,
              label: "Aestus Domus Aurea",
              romaji: "Maneki Tou Ougon Gekijou: Aestus Domus Aurea",
              jp: "招き蕩う黄金劇場 -アエストゥス・ドムス・アウレア-",
              es: "Aestus Domus Aurea",
              completed: false
            },
            {
              id: "extra-10",
              number: 10,
              label: "Unlimited/Raise Dead",
              romaji: "Mugen no Zangai: Unlimited/Raise Dead",
              jp: "無限の残骸 -アンリミテッド／レイズ・デッド-",
              es: "Los restos de la batalla infinita",
              completed: false
            }
          ]
        },
        {
          id: "fate-extra-2",
          label: "Fate/Extra Last Encore: Illustrias Tendousetsu",
          format: "Anime",
          note: "También conocida como 'Geocentrismo ilustre' - Continuación de Fate/Extra Last Encore",
          completed: false,
          opened: false,
          episodes: [
            {
              id: "extra-ill-1",
              number: 1,
              label: "Resurrected Sword of Victory: Excalibur Galatine",
              romaji: "Tenrin Suru Shouri no Ken: Excalibur Galatine",
              jp: "転輪する勝利の剣 エクスカリバー・ガラティーン",
              es: "La Espada de la Victoria Resucitada: Excalibur Galatine",
              completed: false
            },
            {
              id: "extra-ill-2",
              number: 2,
              label: "Turner of the Wheel: Chakra Vartin",
              romaji: "Tenrinjouou: Chakra Vartin",
              jp: "天輪聖王 チャクラ・ヴァルティン",
              es: "El que Gira la Rueda: Chakra Vartin",
              completed: false
            },
            {
              id: "extra-ill-3",
              number: 3,
              label: "The Applauding Rose: Olympia Plaudere",
              romaji: "Kassai no Bara: Olympia Plaudere",
              jp: "喝采の薔薇 オリンピア・プラウデーレ",
              es: "La Rosa que Aplaude: Olympia Plaudere",
              completed: false
            }
          ]
        },
