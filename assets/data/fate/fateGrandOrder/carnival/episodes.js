export const fgo_car_1 = {
  id: "fgo-car-1",
  number: 1,
  completed: false,
  label: {
    en: "Eirei Genkai Taisai Olympia: The Great Transformation of the Kyouen - Volume of the Great Spirit Conversion Plan",
...
export const fgo_car_2 = {
  id: "fgo-car-2",
  number: 2,
  completed: false,
  label: {
    en: "Night's Special Feature Kabukicho",
...
export const fgo_car_3 = {
  id: "fgo-car-3",
  number: 3,
  completed: false,
  label: {
    en: "The Documentary: Expanding the Gap of the Heroic Spirit - The Heroic Labor Standards Law",
...
export const fgo_car_4 = {
  id: "fgo-car-4",
  number: 4,
  completed: false,
  label: {
    en: "Kizuna Max Channel",
