export const fgo_solomon_special_1 = {
  id: "fgo-solomon-special-1",
  number: 1,
  completed: false,
  label: {
    en: "Fate/Grand Order TV Special: Absolute Demonic Front Babylonia Summary",
...
export const fgo_solomon_special_2 = {
  id: "fgo-solomon-special-2",
  number: 2,
  completed: false,
  label: {
    en: "Fate/Grand Order TV Special: Grand Temple of Time Solomon Premiere Commemoration",
